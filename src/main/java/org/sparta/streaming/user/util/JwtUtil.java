package org.sparta.streaming.user.util;
...
public class JwtUtil {
    ...
    @Value("EsetCpN+LXsOKhbZJYGezsD8YfSr02ml3BSjvFl1EH1+sfP+Jh0uR2PHlWGNrUyXJwtTmwata9AMQdKSDyxVww==") // Base64 인코딩된 비밀키 문자열
